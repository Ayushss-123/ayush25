              ...
              <div className={styles.frameDiv19}>
                ...
                <div className={styles.groupDiv4}>
                  <img
                    ...
                    src="../group-6751.svg"
                  />
                  <div className={styles.h55MNonStop1}>15H 10M, Non-stop</div>
                </div>
              ...
              <div className={styles.frameDiv19}>
                ...
                <div className={styles.groupDiv7}>
                  <img
                    ...
                    src="../group-6752.svg"
                  />
                  <div className={styles.h55MNonStop1}>17H 30M, Non-stop</div>
                </div>
                <div className={styles.groupDiv5}>
              ...
              <div className={styles.frameDiv19}>
                ...
                <div className={styles.groupDiv7}>
                  <img
                    ...
                    src="../group-6752.svg"
                  />
                  <div className={styles.h55MNonStop1}>19H 15M, Non-stop</div>
                </div>
                <div className={styles.groupDiv5}>
                  <div className={styles.pMDiv}>9:50 AM</div>
                  <div className={styles.lAXDiv}>LAX</div>
              ...
              <div className={styles.frameDiv19}>
                ...
                <div className={styles.groupDiv7}>
                  <img
                    ...
                    src="../group-6752.svg"
                  />
                  <div className={styles.h55MNonStop1}>17H 30M, 1-stop</div>
                </div>
                <div className={styles.groupDiv5}>
                  <div className={styles.pMDiv}>9:50 AM</div>
                  <div className={styles.lAXDiv}>LAX</div>
              ...
              <div className={styles.frameDiv19}>
                ...
                <div className={styles.groupDiv7}>
                  <img
                    ...
                    src="../group-6752.svg"
                  />
                  <div className={styles.h55MNonStop1}>33H 10M, 1-stop</div>
                </div>
                <div className={styles.groupDiv5}>
                  <div className={styles.pMDiv}>4:45 PM</div>
                  <div className={styles.lAXDiv}>LAX</div>
              ...
              <div className={styles.frameDiv19}>
                ...
                <div className={styles.groupDiv7}>
                  <img
                    ...
                    src="../group-6752.svg"
                  />
                  <div className={styles.h55MNonStop1}>26H 45M, 1-stop</div>
                </div>
                <div className={styles.groupDiv5}>
